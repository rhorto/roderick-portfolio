...
const jobs = [
  ...
  { co: 'Self-Initiated AI SaaS Projects', title: 'AI Product Designer — Self-Directed R&D', yr: 'Aug 2024–Present', location: 'Remote', bullets: ['Self-funded research and prototyping program exploring AI-native product design — shipping production-grade SaaS platforms to pressure-test LLM UX patterns, agentic workflows, and multi-model orchestration at real scale', 'Shipped an AI job-search SaaS with Gemini-powered legitimacy scoring, decision-maker enrichment (Apollo→Hunter→Prospeo waterfall), AI-generated personalized outreach, and reply classification — React 19, Supabase RLS, Stripe billing across 4 tiers', 'Shipped a multi-tenant B2B marketing platform with AI strategy engine, revenue forecasting, and content generation workflows driven by structured LLM outputs', 'Shipped an account-based marketing field app for outside sales teams — territory mapping, account prioritization, and AI-assisted visit logging', 'Shipped a multi-stream income platform unifying revenue sources with forecasting, goal tracking, and AI-driven earnings optimization', 'Designed AI-native UX patterns: confidence surfaces, trust indicators, token-aware interactions, streaming responses, human-in-the-loop review, and graceful fallback states for model failures', 'Built multi-model orchestration routing tasks across Claude (Opus/Sonnet), Gemini 2.0 Flash, and GPT-4 based on cost, latency, and capability — prompt caching, function calling, and structured outputs at production scale', 'AI & Tooling: Claude API, Gemini 2.0 Flash, GPT-4, prompt caching, function calling, structured outputs, RAG, vector embeddings, Cursor, Claude Code, v0, Figma AI', 'Stack: React 19, TypeScript, Tailwind v4, TanStack Query, Vite, Supabase (Postgres, RLS, Edge Functions), Vercel, Stripe, REST/Webhooks, Apollo, Hunter, Apify'] },
