        ...
        <div className="space-y-5">
          {projects.map((p, i) => (
            <motion.a
              ...
              className="group block rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)]/50 p-6 sm:p-7 hover:border-[var(--color-line-2)] hover:bg-[var(--color-surface)] transition-all duration-300 cursor-default"
            >
              {/* Header */}
              ...
              {/* Description */}
              <p className="text-[13px] text-[var(--color-text-2)] leading-relaxed mt-3 mb-4">
                {p.desc}
              </p>
              ...
              <div className="flex flex-wrap gap-1.5 mb-5">
                {p.tags.map(t => (
                  <span key={t} className="text-[10px] px-2 py-[3px] rounded-full border border-[var(--color-line)] text-[var(--color-text-3)]">
                    {t}
                  </span>
                ))}
              </div>
