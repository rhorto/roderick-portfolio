...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: '2008–2010',
    role: 'UX Designer',
    desc: 'Designed internal applications for financial center agents to service customers online and in-office — streamlining account management, transactions, and customer interactions.',
    tags: ['Enterprise UX', 'Financial Services', 'Internal Tools', 'Agent Experience'],
    color: '#dc2626',
    image: '/images/project-bofa.jpg',
    stats: [['Agent', 'Productivity ↑'], ['Multi', 'Channels'], ['In-Office', '+ Online'], ['Enterprise', 'Scale']],
    constraint: 'Financial center agents juggled multiple legacy systems to service customers — one for accounts, another for transactions, another for customer profiles. Context switching between systems caused delays, errors, and poor customer experiences during both in-office visits and online servicing.',
    options: [
      'Overlay a unified dashboard on top of existing systems — fast deployment but still dependent on legacy backends',
      'Build a single consolidated application replacing all agent tools — highest impact but massive engineering and compliance effort',
      'Design a task-based workflow UI that orchestrates existing systems behind a single interface — balanced approach with phased rollout',
    ],
    bet: 'Designed a task-based workflow interface that unified the agent experience without requiring a full backend rewrite. Agents could handle account inquiries, transactions, and customer updates from a single screen, whether the customer was in-office or online.',
    shipped: 'A suite of internal applications that gave financial center agents a unified view of customer accounts, streamlined transaction workflows, and consistent experience across in-office and online servicing channels.',
    learned: 'Designing for financial services taught me the weight of compliance constraints. Every screen, every workflow had to pass through legal and compliance review. I learned to build compliance requirements into the design process from day one instead of treating them as final-stage checkboxes.',
    results: [
      { metric: 'Unified', label: 'Agent experience across channels' },
      { metric: 'Faster', label: 'Customer service time' },
      { metric: 'Reduced', label: 'Context switching between systems' },
      { metric: 'Multi-Channel', label: 'In-office + online servicing' },
    ],
    tools: ['User Research', 'Wireframing', 'Prototyping', 'Usability Testing', 'Stakeholder Management', 'Compliance Design'],
    before: 'Agents switching between 3-4 legacy systems. Slow customer service. Inconsistent experience between in-office and online. High error rates. Training-intensive onboarding.',
    after: 'Unified agent interface. Faster servicing. Consistent in-office and online experience. Reduced errors. Simplified training for new agents.',
  },
  {
    id: 'ihg',
